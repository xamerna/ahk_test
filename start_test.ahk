...
if A_PtrSize = 8 {
    if !FileExist(exePath := IniRead('settings_test.ini', 'Paths', '32bitAhkExePath', '')) {
    ...
    IniWrite(exePath, 'settings_test.ini', 'Paths', '32bitAhkExePath')
    Run exePath . ' "' . A_ScriptFullPath . '"'
    ExitApp
}
if !FileExist(dllPath2 := IniRead('settings_test.ini', 'Paths', 'AutoHotkey2Dll', '')) {
    dllPath2 := FileSelect(1, A_ScriptDir, 'Select AutoHotkey2.dll', 'DLL (*.dll)')
    if !FileExist(dllPath2) {
        ExitApp
    }
    IniWrite(dllPath2, 'settings_test.ini', 'Paths', 'AutoHotkey2Dll')
}

if !FileExist(dllPath := IniRead('settings_test.ini', 'Paths', 'AutoHotkeyDll', '')) {
    dllPath := FileSelect(1, A_ScriptDir, 'Select AutoHotkey.dll', 'DLL (*.dll)')
    if !FileExist(dllPath) {
        ExitApp
    }
    IniWrite(dllPath, 'settings_test.ini', 'Paths', 'AutoHotkeyDll')
}
...
test_message := DllCall(KEahkGetVar2, 'Str', 'test_value_string_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
...
test_message := DllCall(KEahkGetVar2, 'Str', 'test_value_float_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
DllCall(KEahkgetvar, 'Str', 'test_value_float_message', 'Ptr', test_message, 'UInt', 1000, 'UInt', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path  

test_message := DllCall(KEahkGetVar2, 'Str', 'test_value_int_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
...
test_message := DllCall(KEahkGetVar2, 'Str', 'test_var_string_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
DllCall(KEahkgetvar, 'Str', 'test_var_string_message', 'Ptr', test_message, 'UInt', 1000, 'UInt', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path  

test_message := DllCall(KEahkGetVar2, 'Str', 'test_var_float_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
DllCall(KEahkgetvar, 'Str', 'test_var_float_message', 'Ptr', test_message, 'UInt', 1000, 'UInt', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path  

test_message := DllCall(KEahkGetVar2, 'Str', 'test_var_int_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
...
test_message := DllCall(KEahkGetVar2, 'Str', 'test_1par_VarString_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
DllCall(KEahkgetvar, 'Str', 'test_1par_VarString_message', 'Ptr', test_message, 'UInt', 1000, 'UInt', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path  

test_message := DllCall(KEahkGetVar2, 'Str', 'test_1par_VarInteger_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
DllCall(KEahkgetvar, 'Str', 'test_1par_VarInteger_message', 'Ptr', test_message, 'UInt', 1000, 'UInt', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path  

test_message := DllCall(KEahkGetVar2, 'Str', 'test_1par_VarFloat_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
DllCall(KEahkgetvar, 'Str', 'test_1par_VarFloat_message', 'Ptr', test_message, 'UInt', 1000, 'UInt', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path  



test_message := DllCall(KEahkGetVar2, 'Str', 'test_arr_string_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
DllCall(KEahkgetvar, 'Str', 'test_arr_string_message', 'Ptr', test_message, 'UInt', 1000, 'UInt', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path  

test_message := DllCall(KEahkGetVar2, 'Str', 'test_arr_int_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
DllCall(KEahkgetvar, 'Str', 'test_arr_int_message', 'Ptr', test_message, 'UInt', 1000, 'UInt', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path  

test_message := DllCall(KEahkGetVar2, 'Str', 'test_arr_float_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
DllCall(KEahkgetvar, 'Str', 'test_arr_float_message', 'Ptr', test_message, 'UInt', 1000, 'UInt', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path  



test_message := DllCall(KEahkGetVar2, 'Str', 'test_1par_arr_string_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
DllCall(KEahkgetvar, 'Str', 'test_1par_arr_string_message', 'Ptr', test_message, 'UInt', 1000, 'UInt', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path  

test_message := DllCall(KEahkGetVar2, 'Str', 'test_1par_arr_int_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
DllCall(KEahkgetvar, 'Str', 'test_1par_arr_int_message', 'Ptr', test_message, 'UInt', 1000, 'UInt', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path  

test_message := DllCall(KEahkGetVar2, 'Str', 'test_1par_arr_float_message',  'UInt', 0, 'UInt', threadId_ahk2, 'Ptr', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path   
test_message:=Buffer(1000)
DllCall(KEahkgetvar, 'Str', 'test_1par_arr_float_message', 'Ptr', test_message, 'UInt', 1000, 'UInt', 0, 'Cdecl')
FileAppend StrGet(test_message) . "`n", test_result_Path  
